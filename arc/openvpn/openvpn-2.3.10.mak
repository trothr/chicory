...
#		make rules for OpenVPN at La Casita with /usr/opt
#	  Date: 2016-May-06 (Fri)
#
...
SC_URL		=	\
 https://swupdate.openvpn.org/community/releases/$(SC_SOURCE).$(SC_ARC) \
 https://swupdate.openvpn.org/community/releases/$(SC_SOURCE).$(SC_ARC).asc

SC_SOURCE_VERIFY = gpg --verify arc/$(SC_SOURCE).$(SC_ARC).asc
#gpg --keyserver hkp://pool.sks-keyservers.net/ --recv-keys 0xc29d97ed198d22a3
...
# PAM support disabled solely due to dependency
SC_BUILD	=	$(MAKE)
SC_INSTALL	=	$(MAKE) install

# default for this is blank, varies widely per package
SC_FIXUP	=	strip sbin/openvpn
...
# historical
SHARED		=	man
REQ		=	lzo ("in place" and not portable)
