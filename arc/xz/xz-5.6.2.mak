...
#	  Date: 2024-06-05 (Wed) in response to XZ Utils SSHD Backdoor
#
...
SC_URL		=	\
	http://www.tukaani.org/$(APPLID)/$(SC_SOURCE).$(SC_ARC) \
	http://www.tukaani.org/$(APPLID)/$(SC_SOURCE).$(SC_ARC).sig

SC_SOURCE_VERIFY = gpg --verify arc/$(SC_SOURCE).$(SC_ARC).sig
#gpg --keyserver hkp://pool.sks-keyservers.net/ --recv-keys 0x38ee757d69184620
