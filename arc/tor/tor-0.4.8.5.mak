...
SC_SOURCE_VERIFY = gpg --verify arc/tor-0.4.8.5.tar.gz.sha256sum.asc && \
 (cd arc ; sha256sum tor-0.4.8.5.tar.gz) > /tmp/tor-0.4.8.5.tar.gz.sha256sum && \
 cmp arc/tor-0.4.8.5.tar.gz.sha256sum /tmp/tor-0.4.8.5.tar.gz.sha256sum && \
 rm /tmp/tor-0.4.8.5.tar.gz.sha256sum
