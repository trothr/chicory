...
#               make rules for Hercules "Spinhawk" at La Casita with Chicory
#         Date: 2024-03-15 (Fri)
#
...
SC_URL         = http://downloads.hercules-390.eu/$(SC_SOURCE).$(SC_ARC)
...
SC_FIXUP        =       strip bin/hercules \
        bin/hercifc bin/dasdinit bin/dasdcopy bin/dasdcat bin/dasdconv \
        bin/dasdisup bin/dasdload bin/dasdls bin/dasdpdsu bin/dasdseq \
        bin/cckdcdsk bin/cckdcomp bin/cckddiag bin/cckdswap \
        bin/dmap2hrc bin/hetget bin/hetinit bin/hetmap bin/hetupd \
        bin/tapecopy bin/tapemap bin/tapesplt
