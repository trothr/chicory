...
#		make rules for GNU Coreutils at La Casita with Chicory
...
#gpg --keyserver hkp://pool.sks-keyservers.net/ --recv-keys 0xdf6fd971306037d9
...
SC_CONFIG	=	./configure --prefix=$(PREFIX)/$(SC_VRM) \
	--enable-no-install-program=coreutils,hostname --enable-mtab
...
SC_FIXUP	=	strip \
	...
	bin/whoami \
	bin/yes \
	bin/b2sum bin/base32 bin/basenc
