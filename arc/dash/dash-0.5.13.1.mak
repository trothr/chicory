...
#               make rules for DASH with Chicory
#	  Date: 2026-03-16 (Mon)
#
...
SC_URL		=	\
 http://gondor.apana.org.au/~herbert/dash/files/$(SC_SOURCE).$(SC_ARC) \
 http://gondor.apana.org.au/~herbert/dash/files/$(SC_SOURCE).$(SC_ARC).sha512sum
# homepage "http://gondor.apana.org.au/~herbert/dash/"

#SC_SOURCE_VERIFY = gpg --verify arc/$(SC_VRM).$(SC_ARC).asc
SC_SOURCE_VERIFY = gpg --verify arc/$(SC_VRM).$(SC_ARC).sha512sum
#gpg --keyserver hkp://pool.sks-keyservers.net --recv-keys 0xc7271d0a49b18ba7
#gpg --keyserver wwwkeys.pgp.net --recv-keys 0xc7271d0a49b18ba7
