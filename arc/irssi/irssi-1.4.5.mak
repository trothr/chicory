...
#               make rules for Irssi at La Casita with Chicory
#         Date: 2023-11-16 (Thu)
#
...
SC_URL          =        \
 https://codeberg.org/irssi/irssi/releases/download/$(SC_APV)/$(SC_VRM).$(SC_ARC) \
 https://codeberg.org/irssi/irssi/releases/download/$(SC_APV)/$(SC_VRM).$(SC_ARC).asc
# https://github.com/irssi/irssi/releases/download/$(SC_APV)/$(SC_VRM).$(SC_ARC) \
# https://github.com/irssi/irssi/releases/download/$(SC_APV)/$(SC_VRM).$(SC_ARC).asc

SC_SOURCE_VERIFY = gpg --verify arc/$(SC_SOURCE).$(SC_ARC).asc
# gpg --keyserver hkp://pgp.mit.edu/ --recv-keys 0x00ccb587ddbef0e1
