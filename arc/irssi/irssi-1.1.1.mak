...
#		make rules for IRSSI with Chicory
#	  Date: 2020-Feb-09 (Sun)
#
...
SC_URL		=	\
 https://github.com/irssi/irssi/releases/download/$(SC_APV)/$(SC_SOURCE).$(SC_ARC) \
 https://github.com/irssi/irssi/releases/download/$(SC_APV)/$(SC_SOURCE).$(SC_ARC).asc
