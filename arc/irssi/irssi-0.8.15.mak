...
#		make rules for IRSSI for /usr/opt
#	  Date: 2014-Apr-16 (Wed)
#
...
SC_URL		=	http://www.irssi.org/files/irssi-0.8.15.tar.gz \
		      http://www.irssi.org/files/irssi-0.8.15.tar.gz.sig
SC_SOURCE_VERIFY = gpg --verify arc/$(SC_VRM).tar.gz.sig
#gpg --keyserver hkp://pool.sks-keyservers.net --recv-keys 0xDDBEF0E1
#gpg --keyserver wwwkeys.pgp.net --recv-keys 0xDDBEF0E1
