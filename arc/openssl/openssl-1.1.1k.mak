...
#               make rules for OpenSSL utilities at La Casita with Chicory
#         Date: 2026-02-12 (Thu) for parity with Neale's work
#
...
SC_URL          =       \
             https://www.openssl.org/source/$(SC_VRM).$(SC_ARC) \
             https://www.openssl.org/source/$(SC_VRM).$(SC_ARC).sha1 \
             https://www.openssl.org/source/$(SC_VRM).$(SC_ARC).sha256 \
             https://www.openssl.org/source/$(SC_VRM).$(SC_ARC).asc

SC_SOURCE_VERIFY = gpg --verify arc/$(SC_SOURCE).$(SC_ARC).asc
#gpg --keyserver hkp://pool.sks-keyservers.net/ --recv-keys 0xd894e2ce8b3d79f5
...
SC_FIXUP        =       strip bin/openssl ; \
                        mkdir share ; mv ssl/man share/. ; \
