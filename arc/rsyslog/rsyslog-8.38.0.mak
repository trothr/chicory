...
#		make rules for RSYSLOG for La Casita with Chicory
#	  Date: 2018-Sep-28 (Fri)
#
...
SC_URL		=	\
 http://www.rsyslog.com/files/download/$(APPLID)/$(SC_SOURCE).$(SC_ARC) \
 http://www.rsyslog.com/files/download/$(APPLID)/$(APPLID)-doc-$(SC_APV).$(SC_ARC)
#sha256 hash: 4d328ed3bcae784e15401c6c20ada2a9be380798ff6bf0da3fe2095915bba22c
...
SC_SOURCE_VERIFY = sha256sum arc/$(SC_SOURCE).$(SC_ARC) \
 | grep 4d328ed3bcae784e15401c6c20ada2a9be380798ff6bf0da3fe2095915bba22c
