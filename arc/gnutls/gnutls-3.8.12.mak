...
#		make rules for GnuTLS brewed with Chicory
#	  Date: 2017-Mar-06 (Mon)
#
...
SC_URL		=	\
 https://www.gnupg.org/ftp/gcrypt/gnutls/v3.5/$(SC_SOURCE).$(SC_ARC) \
 https://www.gnupg.org/ftp/gcrypt/gnutls/v3.5/$(SC_SOURCE).$(SC_ARC).sig
#ftp://ftp.gnutls.org/gcrypt/gnutls/v3.5/

SC_SOURCE_VERIFY = gpg --verify arc/$(SC_SOURCE).$(SC_ARC).sig
#gpg --keyserver hkp://pool.sks-keyservers.net/ --recv-keys 0xeda21e94b565716f
