...
#		make rules for GNU Portable Threads with /usr/opt
#	  Date: 2014-May-15 (Tue) Project Omaha
#
...
#SC_URL = ftp://ftp.ossp.org/pkg/lib/$(APPLID)/$(SC_VRM).$(SC_ARC)
SC_URL	=	ftp://ftp.gnu.org/gnu/$(APPLID)/$(SC_VRM).$(SC_ARC) \
		ftp://ftp.gnu.org/gnu/$(APPLID)/$(SC_VRM).$(SC_ARC).sig
...
#
# configure the package for this platform
_cfg:		_src
#config:	$(APPLID).cfg
...
#
# get the source if not already downloaded
...
#
# confirm source archive signature
verify:
		$(SC_SOURCE_VERIFY)
