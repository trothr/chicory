...
#		make rules for libfastjson for RSYSLOG with Chicory
...
SC_URL		=	\
 http://download.rsyslog.com/$(APPLID)/$(SC_SOURCE).$(SC_ARC)
...
SC_SOURCE_VERIFY = sha256sum arc/$(SC_SOURCE).$(SC_ARC) \
 | grep 3544c757668b4a257825b3cbc26f800f59ef3c1ff2a260f40f96b48ab1d59e07
