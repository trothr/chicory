...
#               make rules for Xastir for La Casita with Chicory
#         Date: 2023-10-11 (Wed)
#
...
#SC_SOURCE      =       $(SC_VRM)
SC_SOURCE       =       Xastir-Release-$(SC_APV)
...
SC_URL          =       \
 https://github.com/Xastir/Xastir/archive/refs/tags/Release-$(SC_APV).$(SC_ARC)
...
SC_FETCH        =       wget --passive-ftp --no-clobber \
                     ...
                     mv Release-2.2.0.tar.gz Xastir-Release-2.2.0.tar.gz

#SC_CONFIG       =       ./configure --prefix=$(PREFIX)/$(SC_VRM)
SC_CONFIG       =       rm -f configure ; ./bootstrap.sh ; \
...
SHARED          =       man
REQ             =       package-v.r.m
#                       autoconf, automake, gcc, glibc, openmotif or lesstiff, X11 window system, make, git
