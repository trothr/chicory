...
#         Date: 2020-Apr-05 (Sun) during Coronavirus lock-down
#
...
SC_URL		=	\
     http://www.greenwoodsoftware.com/$(APPLID)/$(SC_SOURCE).$(SC_ARC) \
     http://www.greenwoodsoftware.com/$(APPLID)/$(SC_SOURCE).sig \
     http://www.greenwoodsoftware.com/$(APPLID)/news.$(SC_APV).html
...
SC_SOURCE_VERIFY = gpg --verify arc/$(SC_SOURCE).sig arc/$(SC_SOURCE).$(SC_ARC)
