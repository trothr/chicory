...
#               make rules for SNMP/SNMPD/Net-SNMP brewed with Chicory
#         Date: 2023-06-20 (Tuesday) multitasking at Velocity training
#
...
SC_URL		=	SOURCEFORGE
# Sourceforge is a great site, hosting many FLOSS projects.
# But you must *manually* drive the download. Sourceforge administrators
# enforce this by regularly changing the download logic of the web site.
#net-snmp-5.9.1.tar.gz
#net-snmp-5.9.1.tar.gz.asc
#net-snmp-admin.asc

SC_SOURCE_VERIFY = gpg --verify arc/$(SC_SOURCE).$(SC_ARC).asc
#gpg --keyserver hkp://pool.sks-keyservers.net/ --recv-keys 0xf07b9d2dacb19fd6
#0xaccb65fd7800feac, 0xd433a441ffef09d7, 0x945b5dba317f8f64, 0x76cf47b8a77c5329
...
#									<
SC_FIXUP	=	strip bin/agentxtrap bin/encode_keychange \
	bin/snmpbulkget bin/snmpbulkwalk bin/snmpdelta bin/snmpdf \
	bin/snmpget bin/snmpgetnext bin/snmpnetstat bin/snmpping \
	bin/snmpset bin/snmpstatus bin/snmptable bin/snmptest \
	bin/snmptranslate bin/snmptrap bin/snmpusm bin/snmpvacm \
	bin/snmpwalk sbin/snmpd sbin/snmptrapd ; \
