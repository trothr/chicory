...
#               make rules for GNU ED at La Casita with Chicory
#         Date: 2023-09-21 (Thu)
#
...
# https://download.savannah.nongnu.org/releases/$(APPLID)/$(SC_SOURCE).$(SC_ARC)
# https://mirrors.sarata.com/non-gnu/$(APPLID)/$(SC_SOURCE).$(SC_ARC)
# https://ftp.gnu.org/pub/gnu/$(APPLID)/$(SC_SOURCE).$(SC_ARC)
