...
#               make rules for ISC DHCP with Chicory
#	  Date: 2018-Oct-13 (Sat)
#
...
SC_URL		=	\
 http://ftp.isc.org/isc/dhcp/$(SC_APV)/$(SC_SOURCE)-RELNOTES \
 http://ftp.isc.org/isc/dhcp/$(SC_APV)/$(SC_SOURCE).$(SC_ARC) \
 http://ftp.isc.org/isc/dhcp/$(SC_APV)/$(SC_SOURCE).$(SC_ARC).asc \
 http://ftp.isc.org/isc/dhcp/$(SC_APV)/$(SC_SOURCE).$(SC_ARC).sha1.asc \
 http://ftp.isc.org/isc/dhcp/$(SC_APV)/$(SC_SOURCE).$(SC_ARC).sha256.asc \
 http://ftp.isc.org/isc/dhcp/$(SC_APV)/$(SC_SOURCE).$(SC_ARC).sha512.asc
SC_SOURCE_VERIFY = gpg --verify arc/$(SC_VRM).$(SC_ARC).asc
#gpg --keyserver hkp://pool.sks-keyservers.net --recv-keys 6fa6ebc9911a4c02
