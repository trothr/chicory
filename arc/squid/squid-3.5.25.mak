...
#		make rules for Squid Proxy brewed with Chicory
#	  Date: 2017-Apr-12 (Wed)
#
...
SC_URL		=	\
   http://www.squid-cache.org/Versions/v3/3.5/$(SC_SOURCE).$(SC_ARC) \
   http://www.squid-cache.org/Versions/v3/3.5/$(SC_SOURCE).$(SC_ARC).asc

SC_SOURCE_VERIFY = gpg --verify arc/$(SC_SOURCE).$(SC_ARC).asc
#gpg --keyserver hkp://pool.sks-keyservers.net/ --recv-keys 0xb268e706ff5cf463
...
SC_FIXUP	=	strip sbin/squid bin/squidclient bin/purge
