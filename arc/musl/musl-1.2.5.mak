...
SC_URL          =       \
               https://musl.libc.org/releases/$(SC_SOURCE).$(SC_ARC) \
               https://musl.libc.org/releases/$(SC_SOURCE).$(SC_ARC).asc

SC_SOURCE_VERIFY = gpg --keyid-format long --verify arc/$(SC_SOURCE).$(SC_ARC).asc
