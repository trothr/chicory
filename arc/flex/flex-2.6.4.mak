...
#		make rules for Flex at La Casita with Chicory
...
SC_URL		=	\
 https://github.com/westes/flex/releases/download/v$(SC_APV)/$(SC_SOURCE).$(SC_ARC) \
 https://github.com/westes/flex/releases/download/v$(SC_APV)/$(SC_SOURCE).$(SC_ARC).sig

SC_SOURCE_VERIFY = gpg --verify arc/$(SC_SOURCE).$(SC_ARC).sig
#gpg --keyserver hkp://pool.sks-keyservers.net/ --recv-keys 0xe4b29c8d64885307
