...
#		make rules for ooRexx at La Casita with /usr/opt
#	  Date: 2016-Apr-10 (Sun)
#
...
SC_FETCH	=	wget --passive-ftp --no-clobber $(SC_URL) ; \
			mv $(SC_SOURCE)-source.$(SC_ARC) $(SC_SOURCE).$(SC_ARC)
SC_CONFIG	=	./configure --prefix=$(PREFIX)/$(SC_VRM)
SC_BUILD	=	$(MAKE)
SC_INSTALL	=	$(MAKE) install

# default for this is blank, varies widely per package
SC_FIXUP	=	strip bin/rexx \
	bin/rexxc bin/rexximage bin/rxapi bin/rxqueue bin/rxsubcom
