...
#		make rules for PDSH at La Casita with /usr/opt
#	  Date: 2016-Jul-21 (Thu)
#
...
SC_URL		=	https://github.com/grondo/pdsh
#   https://code.google.com/archive/p/pdsh/downloads/$(SC_VRM).$(SC_ARC)
#http://pdsh.googlecode.com/files/$(SC_VRM).$(SC_ARC)
#https://storage.googleapis.com/google-code-archive-downloads/v2/code.google.co$

#SC_SOURCE_VERIFY = gpg --verify arc/$(SC_SOURCE).tar.sig
...
SC_FETCH	=	rm -r $(APPLID) $(SC_SOURCE) ; \
			git clone $(SC_URL) ; \
			yes | rm -r $(APPLID)/.git ; \
			mv $(APPLID) $(SC_SOURCE) ; \
			tar cJf $(SC_VRM).$(SC_ARC) $(SC_VRM)
