...
#		make rules for PDSH for La Casita with /usr/opt
#	  Date: 2014-Dec-15 (Mon) Project Omaha and NORD
#
...
SC_URL		=   http://pdsh.googlecode.com/files/$(SC_VRM).$(SC_ARC)
#https://pdsh.googlecode.com/files/$(SC_VRM).$(SC_ARC)
#SC_SOURCE_VERIFY = gpg --verify arc/$(SC_VRM).$(SC_ARC).asc
#gpg --keyserver x-hkp://pool.sks-keyservers.net --recv-keys 0xnnnnnnnnnnnnnnnn
