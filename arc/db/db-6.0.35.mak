...
#		make rules for Berkeley DB at La Casita with Chicory
#	  Date: 2018-Jan-13 (Sun)
#
...
SC_URL		=	\
   http://download.oracle.com/otn/berkeley-db/$(SC_SOURCE).$(SC_ARC) \
   http://download.oracle.com/otn/berkeley-db/$(SC_SOURCE).$(SC_ARC).md5
#http://www.linuxfromscratch.org/blfs/view/7.5/server/db.html
...
SC_CONFIG	=	../dist/configure --prefix=$(PREFIX)/$(SC_VRM) \
					--enable-compat185 \
					--enable-dbm       \
...
#SC_BUILDD	=		$(SC_SOURCE)
SC_BUILDD	=		$(SC_SOURCE)/build_unix
