...
#		make rules for Libksba at La Casita with /usr/opt Chicory
#	  Date: 2015-Sep-28 (Wed)
#
...
SC_URL		=	\
	    ftp://ftp.gnupg.org/gcrypt/$(APPLID)/$(SC_VRM).$(SC_ARC) \
	    ftp://ftp.gnupg.org/gcrypt/$(APPLID)/$(SC_VRM).$(SC_ARC).sig
