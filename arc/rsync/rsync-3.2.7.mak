...
#		make rules for RSYNC at La Casita with /usr/opt Chicory
#         Date: 2023-05-15 (Mon) prodded by Open Indiana
#	  Note: still suspicious of a "security" fix which breaks things
#
...
SC_URL		=	\
   http://rsync.samba.org/ftp/$(APPLID)/src/$(SC_SOURCE).$(SC_ARC) \
   http://rsync.samba.org/ftp/$(APPLID)/src/$(SC_SOURCE).$(SC_ARC).asc

SC_SOURCE_VERIFY = gpg --verify arc/$(SC_SOURCE).$(SC_ARC).asc
#gpg --keyserver hkp://pool.sks-keyservers.net/ --recv-keys 0x6c859fb14b96a8c5
