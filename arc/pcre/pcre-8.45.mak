...
#               make rules for Perl Compatible Regular Expressions
#         Date: 2023-08-01 (Tue) dependency hell
#
...
SC_URL          =       \
	    http://www.pcre.org/pub/$(APPLID)/$(SC_SOURCE).$(SC_ARC) \
	    http://www.pcre.org/pub/$(APPLID)/$(SC_SOURCE).$(SC_ARC).sig

SC_SOURCE_VERIFY = gpg --verify arc/$(SC_SOURCE).$(SC_ARC).asc
#gpg --keyserver hkp://pool.sks-keyservers.net/ --recv-keys 0x9766e084fb0f43d8
...
SC_FIXUP	=	strip bin/pcregrep bin/pcretest ; \
