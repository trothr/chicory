...
#		make rules for Tcl at La Casita with Chicory
#	  Date: 2020-Nov-06 (Fri)
#
...
verify: 	arc/$(SC_SOURCE)-src.tar.gz
		$(SC_SOURCE_VERIFY)
...
#		$(SC_TAR) arc/$(SC_SOURCE).$(SC_ARC)
		$(SC_TAR) arc/$(SC_SOURCE)-src.tar.gz
		test -d $(SC_SOURCE)
		ln -s $(SC_SOURCE) src
