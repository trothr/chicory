...
#               make rules for XZ at La Casita brewed with Chicory
#         Date: 2024-08-09 (Fri)
#
...
SC_URL          =       \
 https://www.openldap.org/software/download/OpenLDAP/openldap-release/$(SC_SOURCE).$(SC_ARC) \
 https://www.openldap.org/software/download/OpenLDAP/openldap-release/$(SC_SOURCE).$(SC_ARC).asc

SC_SOURCE_VERIFY = gpg --verify arc/$(SC_SOURCE).$(SC_ARC).asc
#gpg --keyserver hkp://pool.sks-keyservers.net/ --recv-keys 0x7f67d5fd1ce1cbce
...
SC_FIXUP        =       strip bin/xz bin/xzdec bin/lzmadec bin/lzmainfo ; \
