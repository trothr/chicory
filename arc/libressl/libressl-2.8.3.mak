...
#		make rules for LibreSSL for La Casita with Chicory
#         Date: 2018-Dec-15 (Sat)
#
...
SC_URL		=	\
 http://ftp.openbsd.org/pub/OpenBSD/LibreSSL/$(SC_SOURCE).$(SC_ARC) \
 http://ftp.openbsd.org/pub/OpenBSD/LibreSSL/$(SC_SOURCE).$(SC_ARC).asc \
 http://ftp.openbsd.org/pub/OpenBSD/LibreSSL/$(SC_SOURCE)-relnotes.txt \
 http://ftp.openbsd.org/pub/OpenBSD/LibreSSL/$(APPLID).asc \
 http://ftp.openbsd.org/pub/OpenBSD/LibreSSL/$(APPLID).pub
