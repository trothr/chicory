...
#               make rules for LibreSSL at La Casita with Chicory
#         Date: 2025-02-18 (Tue) 156 The Way
#
...
SC_SOURCE_VERIFY = gpg --keyid-format 0xlong --verify arc/$(SC_SOURCE).$(SC_ARC).asc
