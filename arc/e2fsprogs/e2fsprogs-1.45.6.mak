...
#		make rules for E2FSprogs at La Casita with Chicory
#	  Date: 2020-Apr-04 (Sat) during Coronavirus lock-down
#
...
SC_URL		=	\
 https://mirrors.edge.kernel.org/pub/linux/kernel/people/tytso/$(APPLID)/v$(SC_APV)/$(SC_SOURCE).$(SC_ARC) \
 https://mirrors.edge.kernel.org/pub/linux/kernel/people/tytso/$(APPLID)/v$(SC_APV)/$(SC_SOURCE).tar.sign
...
SC_FIXUP	=	strip bin/chattr bin/lsattr bin/uuidgen \
	sbin/badblocks sbin/blkid sbin/debugfs sbin/dumpe2fs \
	sbin/e2freefrag sbin/e2fsck sbin/e2image sbin/e2label \
	sbin/e2mmpstatus sbin/e2undo sbin/e4crypt sbin/e4defrag \
	sbin/filefrag sbin/findfs sbin/fsck sbin/fsck.ext2 \
	sbin/fsck.ext3 sbin/fsck.ext4 sbin/logsave sbin/mke2fs \
	sbin/mkfs.ext2 sbin/mkfs.ext3 sbin/mkfs.ext4 sbin/mklost+found \
	sbin/resize2fs sbin/tune2fs ; \
