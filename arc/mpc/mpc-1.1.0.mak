...
#		make rules for MPC at La Casita with /usr/opt Chicory
#	  Date: 2018-Jul-23 (Mon) in response to by Petros Koutoupis DIY
#
...
SC_URL		=	\
		  https://ftp.gnu.org/gnu/mpc/$(SC_SOURCE).$(SC_ARC) \
		  https://ftp.gnu.org/gnu/mpc/$(SC_SOURCE).$(SC_ARC).sig

SC_SOURCE_VERIFY = gpg --verify arc/$(SC_SOURCE).$(SC_ARC).sig
#gpg --keyserver hkp://pool.sks-keyservers.net/ --recv-keys 0xf7d5c9bf765c61e3
...
SC_CONFIG       =       ./configure --prefix=$(PREFIX)/$(SC_VRM) \
				...
				--with-gmp=/usr/opt/gmp \
				--with-mpfr=/usr/opt/mpfr
SC_BUILD	=	$(MAKE)
...
# historical
SHARED		=	man
REQ		=	GMP # known to work with gmp-6.1.0
#			MPFR # known to work with mpfr-3.1.3
