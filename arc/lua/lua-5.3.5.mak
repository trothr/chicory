...
#		make rules for Lua for La Casita with Chicory
#	  Date: 2020-Feb-04 (Tue)
#
...
SC_URL		=	http://www.lua.org/ftp/$(SC_SOURCE).$(SC_ARC)
...
#SC_BUILD	=	$(MAKE)   ... see SC_BUILDX below

#SC_INSTALL	=	$(MAKE) install
SC_INSTALL	=	$(MAKE) INSTALL_TOP=$(PREFIX)/$(SC_VRM) install

# default for this is blank, varies widely per package
#SC_FIXUP	=	strip bin/lua bin/luac
...
#SC_BUILDX	=		$(MAKE)
SC_BUILDX	=		$(MAKE) INSTALL_TOP=$(PREFIX)/$(SC_VRM) posix
#Please do 'make PLATFORM' where PLATFORM is one of these:
#   aix bsd c89 freebsd generic linux macosx mingw posix solaris
# see also: http://www.linuxfromscratch.org/blfs/view/svn/general/lua.html
