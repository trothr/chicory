...
SC_URL		=	\
 https://mirrors.edge.kernel.org/pub/software/scm/git/$(SC_SOURCE).$(SC_ARC) \
 https://mirrors.edge.kernel.org/pub/software/scm/git/$(SC_SOURCE).tar.sign \
 https://mirrors.edge.kernel.org/pub/software/scm/git/$(APPLID)-htmldocs-$(SC_APV).$(SC_ARC) \
 https://mirrors.edge.kernel.org/pub/software/scm/git/$(APPLID)-htmldocs-$(SC_APV).tar.sign \
 https://mirrors.edge.kernel.org/pub/software/scm/git/$(APPLID)-manpages-$(SC_APV).$(SC_ARC) \
 https://mirrors.edge.kernel.org/pub/software/scm/git/$(APPLID)-manpages-$(SC_APV).tar.sign
