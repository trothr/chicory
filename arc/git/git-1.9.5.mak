...
#		make rules for Git at La Casita with /usr/opt
#	  Date: 2016-Jul-22 (Fri)
#
...
SC_URL		=	\
    https://www.kernel.org/pub/software/scm/git/$(SC_SOURCE).$(SC_ARC) \
    https://www.kernel.org/pub/software/scm/git/$(SC_SOURCE).tar.sign

#SC_SOURCE_VERIFY = gpg --verify arc/$(SC_SOURCE).tar.sign
