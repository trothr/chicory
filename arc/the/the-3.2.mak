...
#		make rules for The Hessling Editor for La Casita 
#	  Date: 2006-Feb-27 (Mon) Heritage Green 
# 
# 
...
# no default 
#SC_URL = \
# http://easynews.dl.sourceforge.net/sourceforge/hessling-editor/THE-3.2.tar.gz
SC_URL = \
 http://downloads.sourceforge.net/project/$(APPLID)/$(SC_SOURCE).$(SC_ARC)
