...
#               make rules for OATH Toolkit with Chicory for La Casita
#         Date: 2025-12-16 (Tue) Bonaire
#
...
SC_URL          =       \
 https://download.savannah.nongnu.org/releases/oath-toolkit/$(SC_SOURCE).$(SC_ARC) \
 https://download.savannah.nongnu.org/releases/oath-toolkit/$(SC_SOURCE).$(SC_ARC).proof \
 https://download.savannah.nongnu.org/releases/oath-toolkit/$(SC_SOURCE).$(SC_ARC).sig

SC_SOURCE_VERIFY = gpg --verify arc/$(SC_SOURCE).$(SC_ARC).sig
#gpg --keyserver hkp://pool.sks-keyservers.net/ --recv-keys 0x51722b08fe4745a2
