...
#		make rules for OATH-Toolkit for La Casita with Chicory
#	  Date: 2019-May-07 (Tue)
#
...
SC_URL		=	\
 http://download.savannah.nongnu.org/releases/oath-toolkit/$(SC_SOURCE).$(SC_ARC) \
 http://download.savannah.nongnu.org/releases/oath-toolkit/$(SC_SOURCE).$(SC_ARC).sig

SC_SOURCE_VERIFY = gpg --verify arc/$(SC_SOURCE).$(SC_ARC).sig
#gpg --keyserver hkp://pool.sks-keyservers.net/ --recv-keys 0x860b7fbb32f8119d
