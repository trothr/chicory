...
#               make rules for LibExpat XML parser for La Casita with Chicory
...
SC_URL          =       \
 https://github.com/libexpat/libexpat/releases/download/R_2_5_0/$(SC_SOURCE).$(SC_ARC) \
 https://github.com/libexpat/libexpat/releases/download/R_2_5_0/$(SC_SOURCE).$(SC_ARC).asc

SC_SOURCE_VERIFY = gpg --verify arc/$(SC_SOURCE).$(SC_ARC).asc
#gpg --keyserver hkp://pool.sks-keyservers.net/ --recv-keys 0x96262acffbd3aec6
