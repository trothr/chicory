...
#SC_SOURCE	=	$(SC_VRM)
SC_SOURCE	=	libevent-2.1.11-stable
...
SC_URL		=	\
 https://github.com/libevent/libevent/releases/download/release-$(SC_APV)-stable/libevent-$(SC_APV)-stable.$(SC_ARC) \
 https://github.com/libevent/libevent/releases/download/release-$(SC_APV)-stable/libevent-$(SC_APV)-stable.$(SC_ARC).asc
