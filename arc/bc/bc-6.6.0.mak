...
#               make rules for Gavin Howard's BC brewed with Chicory
...
#
#               This BC bc-6.6.0 is not to be confused with
#               Gnu BC in this collection most recently bc-2.1.3.
#
...
SC_URL		=	\
	https://git.gavinhoward.com/gavin/bc/archive/$(SC_APV).$(SC_ARC)
...
SC_FETCH	=	wget --passive-ftp --no-clobber \
			...
			ln -s $(SC_APV).$(SC_ARC) $(SC_VRM).$(SC_ARC)
