...
#		make rules for MPFR at La Casita with /usr/opt Chicory
...
SC_URL		=	\
		   http://www.mpfr.org/$(SC_VRM)/$(SC_VRM).$(SC_ARC) \
		   http://www.mpfr.org/$(SC_VRM)/$(SC_VRM).$(SC_ARC).asc

SC_SOURCE_VERIFY = gpg --verify arc/$(SC_SOURCE).$(SC_ARC).asc
#gpg --keyserver hkp://pool.sks-keyservers.net/ --recv-keys 0x980c197698c3739d
