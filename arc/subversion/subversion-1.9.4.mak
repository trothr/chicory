...
#		make rules for Subversion at La Casita with /usr/opt
#	  Date: 2016-Oct-27 (Thu)
#
...
SC_URL		=	\
 https://www.apache.org/dist/$(APPLID)/$(SC_SOURCE).$(SC_ARC) \
 https://www.apache.org/dist/$(APPLID)/$(SC_SOURCE).$(SC_ARC).sha1 \
 https://www.apache.org/dist/$(APPLID)/$(SC_SOURCE).$(SC_ARC).asc

SC_SOURCE_VERIFY = gpg --verify arc/$(SC_SOURCE).$(SC_ARC).asc
#gpg --keyserver hkp://pool.sks-keyservers.net/ --recv-keys 0xb64fff1209f9fa74
...
SC_CONFIG	=	./configure --prefix=$(PREFIX)/$(SC_VRM) \
				...
				--with-apr-util=/usr/opt/apache \
				--with-apr=/usr/opt/apache \
				--without-sqlite
SC_BUILD	=	$(MAKE)
SC_INSTALL	=	$(MAKE) install

# default for this is blank, varies widely per package
SC_FIXUP	=	strip bin/svn \
	bin/svnadmin \
	bin/svnbench \
	bin/svndumpfilter \
	bin/svnfsfs \
