...
SC_URL		=	\
	http://archive.apache.org/dist/httpd/$(APPLID)/$(SC_SOURCE).$(SC_ARC) \
	http://archive.apache.org/dist/httpd/$(APPLID)/$(SC_SOURCE).$(SC_ARC).asc \
	http://archive.apache.org/dist/httpd/$(APPLID)/$(SC_SOURCE).$(SC_ARC).md5 \
	http://archive.apache.org/dist/httpd/$(APPLID)/$(SC_SOURCE).$(SC_ARC).sha256 \
	http://archive.apache.org/dist/httpd/$(APPLID)/$(SC_SOURCE).$(SC_ARC).sha512
