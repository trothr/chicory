...
#		make rules for Regina REXX for La Casita with /usr/opt
#	  Date: 2008-Aug-03 (Sun) Project Omaha
#
...
#SC_SOURCE	=		$(SC_VRM)
SC_SOURCE	=		Regina-3.4

#
# no default
#SC_URL = http://superb-east.dl.sourceforge.net/sourceforge/regina-rexx/Regina-REXX-3.4.tar.gz
#SC_URL = http://umn.dl.sourceforge.net/sourceforge/regina-rexx/Regina-REXX-3.4.tar.gz
#SC_URL = http://unc.dl.sourceforge.net/sourceforge/regina-rexx/Regina-REXX-3.4.tar.gz
#SC_URL = http://internap.dl.sourceforge.net/sourceforge/regina-rexx/Regina-REXX-3.4.tar.gz
SC_URL = http://iweb.dl.sourceforge.net/sourceforge/regina-rexx/Regina-REXX-3.4.tar.gz
#SC_URL = http://easynews.dl.sourceforge.net/sourceforge/regina-rexx/Regina-REXX-3.4.tar.gz
...
SC_FETCH	=	wget --passive-ftp --no-clobber $(SC_URL) ; \
			ln -s Regina-REXX-3.4.tar.gz Regina-3.4.tar.gz
...
#SC_CONFIG	=	./configure.gnu --prefix=$(PREFIX)/$(SC_VRM)
#SC_CONFIG	=	./configure --prefix=$(PREFIX)/$(SC_VRM) \
#				--disable-nls --without-nls \
#			--includedir=/usr/opt/ncurses/include \
#			--libdir=/usr/opt/ncurses/lib
SC_CONFIG	=	./configure --prefix=$(PREFIX)/$(SC_VRM) \
				--with-staticfunctions \
				--disable-shared --enable-static

#
# default is blank
SC_FIXUP	=	strip bin/rexx bin/rxqueue \
				bin/rxstack bin/regina
