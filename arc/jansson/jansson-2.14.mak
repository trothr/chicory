...
#		make rules for JANSSON at La Casita with Chicory
#	  Date: 2022-Apr-06 (Wed)
#
...
#SC_URL		=	\
#	 http://www.digip.org/$(APPLID)/releases/$(SC_VRM).$(SC_ARC) \
#	 http://www.digip.org/$(APPLID)/releases/$(SC_VRM).$(SC_ARC).asc
SC_URL		=	\
 https://github.com/akheron/$(APPLID)/releases/download/v$(SC_APV)/$(SC_VRM).$(SC_ARC) \
 https://github.com/akheron/$(APPLID)/releases/download/v$(SC_APV)/$(SC_VRM).$(SC_ARC).asc

SC_SOURCE_VERIFY = gpg --verify arc/$(SC_SOURCE).$(SC_ARC).asc
#gpg --keyserver hkp://pool.sks-keyservers.net/ --recv-keys 0xd3657d24d058434c
