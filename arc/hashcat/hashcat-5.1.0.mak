...
#		make rules for hashcat at La Casita with Chicory
#	  Date: 2019-May-18 (Sat) general!
#
...
SC_URL		=	\
		    https://hashcat.net/files/$(SC_SOURCE).$(SC_ARC) \
		    https://hashcat.net/files/$(SC_SOURCE).$(SC_ARC).asc
