...
#		make rules for the Apache Web Server at La Casita
#	  Date: 2008-Mar-05 (Wed) ... another sick day
...
# no default
SC_VRM		=	httpd-2.2.19
APPVER          =       apache-2.2.19

# no default
#SC_URL = http://www.tux.org/pub/net/apache/dist/httpd/$(SC_VRM).tar.gz \
#       http://www.tux.org/pub/net/apache/dist/httpd/$(SC_VRM).tar.gz.asc
#SC_URL      =       http://ftp.wayne.edu/apache/httpd/$(SC_VRM).tar.gz \
#                  http://ftp.wayne.edu/apache/httpd/$(SC_VRM).tar.gz.asc
SC_URL		=	\
	http://archive.apache.org/dist/httpd/$(SC_VRM).tar.gz \
	http://archive.apache.org/dist/httpd/$(SC_VRM).tar.gz.asc \
	http://archive.apache.org/dist/httpd/$(SC_VRM).tar.gz.md5 \
	http://archive.apache.org/dist/httpd/$(SC_VRM).tar.gz.sha1
...
SC_CONFIG	=	./configure --prefix=$(PREFIX)/$(APPVER) \
...
# default is blank
#SHARED          =       logs cgi-bin icons man manual error htdocs conf
STRIPPED        =       bin/httpd bin/htpasswd \
	bin/rotatelogs bin/logresolve bin/htdigest \
	bin/htdbm bin/checkgid bin/ab \
	bin/htcacheclean bin/httxt2dbm
SC_FIXUP	=	strip $(STRIPPED)
