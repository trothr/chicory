...
#		make rules for GCC for La Casita with Chicory
#	  Date: 2021-Jun-09 (Wed)
#
...
SC_URL		=	\
 https://ftp.gnu.org/pub/gnu/$(APPLID)/$(SC_VRM)/$(SC_SOURCE).$(SC_ARC) \
 https://ftp.gnu.org/pub/gnu/$(APPLID)/$(SC_VRM)/$(SC_SOURCE).$(SC_ARC).sig
