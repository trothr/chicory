...
#		make rules for cURL at La Casita with Chicory
#	  Date: 2020-Jun-03 (Wed) during the George Floyd fallout
#
...
SC_URL		=	\
		 http://curl.haxx.se/download/$(SC_SOURCE).$(SC_ARC) \
		 http://curl.haxx.se/download/$(SC_SOURCE).$(SC_ARC).asc

SC_SOURCE_VERIFY = gpg --verify arc/$(SC_SOURCE).$(SC_ARC).asc
#gpg --keyserver hkp://pool.sks-keyservers.net/ --recv-keys 0x5cc908fdb71e12c2
...
SHARED		=	man
REQ		=	package-v.r.m
#                       does not appear to like LibreSSL 3.x
