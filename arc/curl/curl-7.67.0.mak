...
#		make rules for cURL at La Casita and VE with Chicory
#	  Date: 2022-Apr-13 (Wed) to keep up with Mars
#
...
SC_URL		=	\
		https://curl.haxx.se/download/$(SC_SOURCE).$(SC_ARC) \
		https://curl.haxx.se/download/$(SC_SOURCE).$(SC_ARC).asc
