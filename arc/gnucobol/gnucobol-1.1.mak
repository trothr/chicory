...
SC_URL		=	\
	      http://ftp.gnu.org/gnu/gnucobol/README \
	      http://ftp.gnu.org/gnu/gnucobol/README.sig \
	      http://ftp.gnu.org/gnu/gnucobol/$(SC_SOURCE).$(SC_ARC) \
	      http://ftp.gnu.org/gnu/gnucobol/$(SC_SOURCE).$(SC_ARC).sig

SC_SOURCE_VERIFY = gpg --verify arc/$(SC_SOURCE).$(SC_ARC).sig
#SC_SOURCE_VERIFY = gpg --verify arc/$(SC_SOURCE).$(SC_ARC).asc
#gpg --keyserver hkp://pool.sks-keyservers.net/ --recv-keys 0x71776baedd20ad42
